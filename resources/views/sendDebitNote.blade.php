...
<div class="sidebar">
    ...
    <a class="active"  href="{{route('sendDebitNote')}}">Enviar Nota Débito </a>
...
<div class="container">
    <form action="POST" name="sendInvoice" id="sendInvoice" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Envío de Nota Débito</div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="select_file">*Encabezado de la nota débito</label>
                    ...
                    <form action="POST" name="sendInvoiceDetail" id="sendInvoiceDetail" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="select_file">*Detalle de la nota débito</label>
                                    <input type="file" class="form-control" id="select_file" name="select_file">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-success" id="send_invoice_group" name="send_invoice_group" disabled="true">Enviar Lode de Notas Débito</button>
                                </div>
                            </div>
...
$(document).ready(function() {
    $.ajaxSetup({
        ...
        sendFormInvoice("#sendInvoice","/uploadFiles/headerDebitNote/type/header",'Enviar Encabezado','#send_invoice','#send_invoice_detail');
        sendFormInvoice("#sendInvoiceDetail","/uploadFiles/detailDebitNote/type/detail",'Enviar Detalle',"#send_invoice_detail",'#send_invoice_group');

        $( "#send_invoice_group" ).click(function() {

            if(confirm('Desea procesar el siguiente lote de notas débito?')){
                ...
                $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $("#send_invoice_group").html('Enviar Lote de Notas Débito');
